...
const About = () => {
  ...
  const cardDetails = {
    education: {
      ...
      content: {
        ...
        highlights: ["77.20 %\u00a0", "Specialization in Full Stack Development", "Active participant in coding competitions", "Member of Computer Science Society"]
      }
    },
    location: {
      title: "Location",
        ...
        >
          ...
          {selectedCard === 'location' && (
            <div className="space-y-4">
              <a
                href="https://maps.app.goo.gl/fQJLGTPdRhjAkVG17"
                target="_blank"
                rel="noopener noreferrer"
                className="relative rounded-xl overflow-hidden h-48 sm:h-64 cursor-pointer group block"
              >
                <iframe
  ...
  return (
    <>
      <section id="about" className="py-8 sm:py-10 md:py-14 relative z-10">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-500 to-purple-500 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
              {t('about.title')}
            </h2>
            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {["Competitive Coding", "Open Source Contributions", "Exploring AI"].map(interest => (
                    <span 
                      key={interest} 
